...
function Signin() {
  ...
  return (
    <div className="relative">
      <div className="flex top-1 right-1 absolute text-2xl mr-1">
        <a className="p-4 m-4 relative flex justify-center items-center transform rotate-45" href="/">
          <div className="absolute h-1 w-7 rounded-full bg-gray-400 "></div>
          <div className="absolute h-7 w-1 rounded-full bg-gray-400 "></div>
        </a>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
            ...
            <div className="mb-4 bg-green-50 border border-green-200 rounded-lg p-3">
              <p className="text-xs text-green-800 text-center">
                <span className="font-semibold">New here?</span> Don't worry! If
                your account doesn't exist, we'll create one for you
                automatically. 🌱
              </p>
            </div>
